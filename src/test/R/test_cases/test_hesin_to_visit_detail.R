...
expect_visit_occurrence(person_id = 1800, visit_start_date = '1997/01/13', visit_end_date = '1997/04/05',
                        record_source_value='HES-1')
expect_visit_detail(person_id = 1800, visit_detail_start_date = '1997/01/13', visit_detail_end_date = '1997/03/30',
                    ...
                    visit_detail_type_concept_id = 44818517, discharge_to_concept_id = 0,
                            visit_occurrence_id = lookup_visit_occurrence('visit_occurrence_id', person_id = 1800, record_source_value = 'HES-1'))
...
expect_visit_detail(person_id = 1801, visit_detail_start_date = '1970/01/01', visit_detail_end_date = '1991/12/06',
                    visit_detail_concept_id = 9201, admitting_source_concept_id = 38003619, discharge_to_concept_id = 38004515,
                            visit_occurrence_id = lookup_visit_occurrence('visit_occurrence_id', person_id = 1801, record_source_value = 'HES-6'))
