...
declareTest(2010, 'Instance 0 - Tumor codes present: histology(40011); histology/1 does not exist')
...
# Instance 0 - Tumor codes present: ICD10(40006) - D-code not included in ICDO3 vocabulary &
# Instance 1 - Tumor codes present: ICD10(40006) &
# Instance 2 - No tumor codes present &
# Instance 4 - Tumor codes present: histology(40011), behaviour(40012) & ICD10(40006) &
...
declareTest(2012, 'Instance 0 - Tumor codes present: ICD10(40006) - C-code not included in ICDO3 vocabulary')
