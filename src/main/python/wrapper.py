...
class Wrapper(BaseWrapper):
    ...
    def load_from_stem_table(self):
        ...
        self.execute_sql_file('src/main/sql/stem_table_to_observation.sql')
        self.execute_sql_file('src/main/sql/stem_table_to_measurement.sql')
        self.execute_sql_file('src/main/sql/stem_table_to_condition_occurrence.sql')
        self.execute_sql_file('src/main/sql/stem_table_to_procedure_occurrence.sql')
        self.execute_sql_file('src/main/sql/stem_table_to_drug_exposure.sql')
        self.execute_sql_file('src/main/sql/stem_table_to_device_exposure.sql')
        self.execute_sql_file('src/main/sql/stem_table_to_specimen.sql')
