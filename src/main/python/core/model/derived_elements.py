...
class Cohort(base):
    ...
    cohort_definition_id = Column(ForeignKey('omopcdm.cohort_definition.cohort_definition_id'), primary_key=True, nullable=False, index=True)
...
class CohortAttribute(base):
    ...
    cohort_end_date = Column(Date, primary_key=True, nullable=False)
    subject_id = Column(Integer, primary_key=True, nullable=False, index=True)
    attribute_definition_id = Column(ForeignKey('omopcdm.attribute_definition.attribute_definition_id'), primary_key=True, nullable=False)
...
class ConditionEra(base):
    ...
    person_id = Column(ForeignKey('cdm_cllear.person.person_id'), nullable=False, index=True)
    condition_concept_id = Column(ForeignKey('omopcdm.concept.concept_id'), nullable=False, index=True)
...
class DoseEra(base):
    ...
    person_id = Column(ForeignKey('cdm_cllear.person.person_id'), nullable=False, index=True)
    drug_concept_id = Column(ForeignKey('omopcdm.concept.concept_id'), nullable=False, index=True)
    unit_concept_id = Column(ForeignKey('omopcdm.concept.concept_id'), nullable=False)
