...
class ConditionOccurrence(base):
    ...
    person_id = Column(ForeignKey('cdm531.person.person_id'), nullable=False, index=False)
    ...
    provider_id = Column(ForeignKey('cdm531.provider.provider_id'))
    visit_occurrence_id = Column(ForeignKey('cdm531.visit_occurrence.visit_occurrence_id'), index=False)
...
class NoteNlp(base):
    ...
    note_id = Column(ForeignKey('cdm531.note.note_id'), nullable=False, index=False)
...
class Person(base):
    ...
    location_id = Column(ForeignKey('cdm531.location.location_id'))
    provider_id = Column(ForeignKey('cdm531.provider.provider_id'))
    care_site_id = Column(ForeignKey('cdm531.care_site.care_site_id'))
...
class Death(base):
    ...
    person_id = Column(ForeignKey('cdm531.person.person_id'), primary_key=True, index=False)
